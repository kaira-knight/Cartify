...
const ProductList = () => {
  ...
  return (
    ...
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 space-y-6">
      ...
      {/* STEP 5: RESPONSIVE HEADER SECTION */}
      <div className="flex flex-col sm:flex-row justify-between gap-4 sm:items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          {/* STEP 6: POLISHED ADD BUTTON (MATCH FIGMA) */}
          <Link
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <>
            {/* STEP 5: SCROLLABLE TABLE (FIXED RESPONSIVENESS) */}
                ...
                <tbody className="divide-y divide-gray-100">
                  {currentItems.map((p) => (
                    <tr key={p._id} className="hover:bg-indigo-50/30 transition-colors group">
                      ...
                      {/* STEP 5: WRAPPING BUTTONS FOR MOBILE */}
